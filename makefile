...
derle:
	...
	gcc -I ./include/ -o ./lib/Populasyon.o -c ./src/Populasyon.c
	gcc -I ./include/ -o ./bin/Test ./lib/Canli.o ./lib/Bitki.o ./lib/Bocek.o ./lib/Sinek.o ./lib/Pire.o ./lib/Habitat.o ./lib/Populasyon.o ./src/Test.c
